...
const int N = 15, M = 15, H = 49;
const int kCAIOi0 = 7, kCAIOj0 = 4, kCAIOlen = 7;
...
public:
  ...
  creature sex(const creature& another, std::mt19937& generator) {  // another is const
    ...
    // and mutations
    static const double kCAFracMutations = 0.001;
    for (int i = 0; i < kCACntGenes; ++i) {
